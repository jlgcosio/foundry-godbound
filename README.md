...
This system is a foundry-godbound system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the Godbound system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-foundry-godbound-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `foundry-godbound` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `foundry-godbound` and `Godbound` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Godbound System](https://gitlab.com/asacolips-projects/foundry-mods/vue3foundry-godbound) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/foundry-godbound.png)
